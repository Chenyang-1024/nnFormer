...
# # for windows version
base = r'/data/cy/projects/DATASET/nnFormer_raw'
preprocessing_output_dir = r'/data/cy/projects/DATASET/nnFormer_preprocessed'
network_training_output_dir_base = r'/data/cy/projects/DATASET/nnFormer_trained_models'
